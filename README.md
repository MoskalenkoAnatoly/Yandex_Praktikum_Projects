...
| [14. Определение температуры для выплавки стали](https://github.com/MoskalenkoAnatoly/Yandex_Praktikum_Projects/tree/main/14.%20Выпускной%20проект) | Построить модель, которая по данным будет предсказывать температуру | Pandas, Numpy, Matplotlib.pyplot, Seaborn, Catboost, Lightgbm |
